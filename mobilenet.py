...
class MobileNet(nn.Module):
    ...
    def __init__(self, num_classes=10):
        ...
        self.linear = nn.Conv2d(32, num_classes, kernel_size=3, 
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, alpha=1.0, round_nearest=8):#alpha超参数
        ...
        last_channel = _make_divisible(32 * alpha, round_nearest)
        ...
        self.linear = nn.Conv2d(last_channel, num_classes, kernel_size=3, 
         stride=1, padding=1, bias=True)
